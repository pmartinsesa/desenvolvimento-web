...
class ContractsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract" do
    assert_difference("Contract.count") do
      post contracts_url, params: { contract: { contractId: @contract.contractId, employee_id: @contract.employee_id } }
    end
  ...
  test "should update contract" do
    patch contract_url(@contract), params: { contract: { contractId: @contract.contractId, employee_id: @contract.employee_id } }
